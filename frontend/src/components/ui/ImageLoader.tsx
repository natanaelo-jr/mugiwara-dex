                    ...
                    >
                        {previewP && !errored ? (
                            ...
                            <div className="flex flex-col items-center text-zinc-500">
                                ...
                                <span className="text-xs">Inserir URL da imagem</span>
                            </div>
                        )}
                    </div>
                </PopoverTrigger>
                ...
                <PopoverContent className="bg-zinc-300 w-min gap-2 flex flex-col">
                    <div className="flex flex-col">
                        <div className="flex items-center shadow-md gap-3 w-min px-3 rounded-sm">
                            <span className="ml-3 text-xs text-zinc-700">Retrato</span>
                            <label>
                                <span className="text-sm px-2 hover:cursor-pointer text-zinc-700 font-medium"><Upload className="w-4 h-4" /> </span>
                                <input type="file" accept="image/*" className="hidden w-full h-full" onChange={handlePChange} />
                            </label>
                            {/* <Input */}
                            {/*     variant="inv" */}
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex items-center shadow-md gap-3 w-min px-3 rounded-sm">
                            ...
                            <label>
                                <span className="text-sm px-2 text-zinc-700 hover:cursor-pointer font-medium"><Upload className="w-4 h-4" /> </span>
                                <input type="file" accept="image/*" className="hidden w-full h-full" onChange={handleIChange} />
                            </label>
                            {/* <Input */}
                            {/*     variant="inv" */}
